...
```{r}
pdf('D:/RepTemplates/mps/sbp/heatmaps_lda_18.pdf')
doc_numbers <- c(1, 18, 72, 75, 79)
# Specify the margins
margins <- c(5, 4)

# Generate heatmap using adjusted margins
heatmap.2(date.topic.probabilities[doc_numbers, ],
          main = "",
          dendrogram = "none",
          keysize = 1,
          margins = margins,
...
```{r}
pdf('D:/RepTemplates/mps/sbp/heatmaps_lda_23.pdf')
doc_numbers <- c(2,3,13,15,46,61,77,81)
# Specify the margins
margins <- c(5, 4)
